...
#python train.py --model_name BiLSTM1d --data_name JNU --data_dir D:/0-Data/1-benchmark/Data/Mechanical-datasets/JNU --normlizetype mean-std --processing_type O_A --checkpoint_dir D:/0-Data/1-benchmark/Benchmark/Benchmark_Results/Order_split/JNU/BiLSTM1d_mean-std_augmentation
    args = parse_args()
